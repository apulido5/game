    ...
    void update() {
        ...
        for (Enemigo enemigo : enemigos) {
            ...
            if (jugador.puntos >= 10){
                temporizadorNuevoEnemigo.frecuencia = 55;
                enemigo.animacion.duracion = 12;
            }
            if (jugador.puntos >= 20){
                temporizadorNuevoEnemigo.frecuencia = 45;
                enemigo.animacion.duracion = 10;
            }
            if (jugador.puntos >= 30){
                temporizadorNuevoEnemigo.frecuencia = 38;
                enemigo.animacion.duracion = 8;
            }
